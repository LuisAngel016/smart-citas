        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[520px] font-poppins border-0 p-0 overflow-visible bg-white dark:bg-gray-800">
                <div className="relative">
                    ...
                    <DialogHeader className="px-8 pt-8 pb-6 space-y-4 bg-linear-to-b from-destructive/5 via-destructive/3 to-transparent dark:from-destructive/10 dark:via-destructive/5">
                        <div className="flex items-start gap-4">
                            {/* Icono con animación */}
                            <div className="relative shrink-0">
                                <div className="absolute inset-0 bg-destructive/20 blur-xl rounded-full animate-pulse" />
                                <div className="relative p-3 rounded-2xl bg-linear-to-br from-destructive/15 to-destructive/5 border-2 border-destructive/20 shadow-lg">
                    ...
                    <DialogFooter className="px-8 py-6 bg-muted/40 dark:bg-gray-900/60 border-t border-border/70 dark:border-gray-700">
                        <div className="flex gap-3 w-full sm:w-auto sm:flex-row-reverse">
                            <Button
                                ...
                                onClick={onConfirm}
                                disabled={isDeleting}
                                className="flex-1 sm:flex-none h-11 bg-linear-to-r from-destructive to-destructive/90 hover:from-destructive/90 hover:to-destructive/80 text-destructive-foreground shadow-lg shadow-destructive/25 hover:shadow-destructive/40 transition-all duration-200 font-medium"
                            >
                                {isDeleting ? (
