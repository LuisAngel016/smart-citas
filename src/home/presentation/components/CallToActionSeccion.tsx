...
export const CallToActionSeccion = () => {
    ...
    return (
        <section
            ...
            className={`bg-primary text-primary-foreground py-12 sm:py-16 md:py-20 transition-all duration-1000 ${isVisible ? 'opacity-100 animate-fade-up animate-duration-[2000ms]' : 'opacity-0 translate-y-10'
                }`}
        >
